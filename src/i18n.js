...
const dict = {
  pl: {
    ...
    "setup.favoriteToggle": "Dodaj/usuń z ulubionych",
    "setup.playedBefore": "Grał(a) wcześniej z:",
    ...
    "tracker.whoServesOtherTeam": "Kto z drużyny {team} serwuje jako pierwszy/a?",
    ...
    "tie.iconTitle": "Rywalizacje drużynowe",
    "tie.listTitle": "Rywalizacje drużynowe",
    "tie.newTie": "Nowa rywalizacja",
    "tie.emptyTitle": "Brak rywalizacji drużynowych",
    "tie.emptyHint": "Utwórz rywalizację, żeby zliczać wygrane mecze między dwiema drużynami.",
    "tie.setupTitle": "Nowa rywalizacja",
    "tie.team1NameLabel": "Nazwa drużyny 1",
    "tie.team2NameLabel": "Nazwa drużyny 2",
    "tie.teamNamePlaceholder": "np. Klub Sportowy",
    "tie.defaultTeam1": "Drużyna 1",
    "tie.defaultTeam2": "Drużyna 2",
    "tie.setupHint": "Później dodasz do rywalizacji dowolną liczbę meczów (single i deble) — wynik to suma wygranych meczów każdej drużyny.",
    "tie.createButton": "Utwórz rywalizację",
    "tie.detailTitle": "Rywalizacja drużynowa",
    "tie.matchesPlayed": "Rozegrano {played} z {total} meczów",
    "tie.addMatchTrack": "Śledź na żywo",
    "tie.addMatchManual": "Zapisz wynik",
    "tie.noMatchesYet": "Dodaj pierwszy mecz tej rywalizacji.",
  ...
  en: {
    ...
    "setup.favoriteToggle": "Add/remove favorite",
    "setup.playedBefore": "Played before with:",
    ...
    "tracker.whoServesOtherTeam": "Who from {team} serves first?",
    ...
    "tie.iconTitle": "Team ties",
    "tie.listTitle": "Team ties",
    "tie.newTie": "New tie",
    "tie.emptyTitle": "No team ties yet",
    "tie.emptyHint": "Create a tie to count won matches between two teams.",
    "tie.setupTitle": "New tie",
    "tie.team1NameLabel": "Team 1 name",
    "tie.team2NameLabel": "Team 2 name",
    "tie.teamNamePlaceholder": "e.g. Sports Club",
    "tie.defaultTeam1": "Team 1",
    "tie.defaultTeam2": "Team 2",
    "tie.setupHint": "You'll add any number of matches (singles and doubles) to the tie afterwards — the tie score is the sum of matches each team wins.",
    "tie.createButton": "Create tie",
    "tie.detailTitle": "Team tie",
    "tie.matchesPlayed": "Played {played} of {total} matches",
    "tie.addMatchTrack": "Track live",
    "tie.addMatchManual": "Save result",
    "tie.noMatchesYet": "Add the first match of this tie.",
