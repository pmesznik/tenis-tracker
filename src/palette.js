...
export const ASTER_FLOWER_BLUE = "#9BACD8";
export const HABANERO = "#F98513";
export const JODHPUR_TAN = "#DAD1C8";
export const DEEP_SPACE_ROYAL = "#223382";
export const DEADLY_DEPTHS = "#111144";
